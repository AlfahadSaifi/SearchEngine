...
<img src="${pageContext.request.contextPath}/static/NSBT-logo-final.png" alt="Logo" height="40" width="40" style="border-radius: 50%;">
            <span style="font-size:120%">NSBT Automation System</span>
        </div>

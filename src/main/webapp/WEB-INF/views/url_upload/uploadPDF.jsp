...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            if ("${not empty uploadSuccess}" === "true") {
                showPopup();
            }
        };
    </script>
...
<body>
    <div class="container">
        <h2 class="text-center text-primary mb-4">Upload PDF</h2>
        <form method="post" enctype="multipart/form-data" action="upload">
            ...
            <div class="form-group">
                ...
                <textarea name="fileDescription" class="form-control" required></textarea>
            </div>
